...
function RaSnackBarContent(props) {
...
const ShowSnackBarContent = withStyles(snackBarContentStyle)(RaSnackBarContent);


const SNACK_BAR_AUTO_HIDE_DURATION = 5000;
class RaSnackBar extends Component {
